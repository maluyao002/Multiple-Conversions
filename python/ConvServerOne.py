...
#  Execution:    python ConvServerOne.py portnum
#  Description: This is a conversion server that converse grams(g) to kilograms(kg) or viceversa
#******************************************************************************
...
def tfunction(Input):
    try: 
        ...
        return (-1)
    if first == 'g' and second == 'kg':
        return float('%.3f' % (amount/1000))
    elif first == 'kg' and second =='g':
        return float('%.3f' % (amount*1000))
    else: 
        return (-1)
