 ...
 *  Compilation:  javac ConvServerThree.java
 *  Execution:    java ConvServerThree portnumber
 *  Description: This is a conversion server that converse pounds(lbs) to onuces(oz) or viceversa
 ******************************************************************************/
...
public class ConvServerThree {
    ...
    public static double tfunction(String input){
        ...
        double amount = Double.parseDouble(tokens[2]);
            if (tokens[0].equals("lbs") && tokens[1].equals("oz")){
                output = amount*16;
                return output;
            }else if(tokens[0].equals("oz") && tokens[1].equals("lbs")){ 
                output = amount/16;
                return output;
            }else{
                return -1;
